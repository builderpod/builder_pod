...
class QuestionSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_set" do
    assert_difference('QuestionSet.count') do
      post question_sets_url, params: { question_set: { interview_type: @question_set.interview_type, oid: @question_set.oid, original_task_oid: @question_set.original_task_oid, set_id: @question_set.set_id, task_id: @question_set.task_id, task_oid: @question_set.task_oid } }
    end
  ...
  test "should update question_set" do
    patch question_set_url(@question_set), params: { question_set: { interview_type: @question_set.interview_type, oid: @question_set.oid, original_task_oid: @question_set.original_task_oid, set_id: @question_set.set_id, task_id: @question_set.task_id, task_oid: @question_set.task_oid } }
